...
func TestOnTransactionCreated(t *testing.T) {
	...
	accountTo, _ := accountService.FindByID(toAccountID)
	accountFrom, _ := accountService.FindByID(fromAccountID)
...
func TestOnTransactionAccountSwitched(t *testing.T) {
	...
	oldAccount, _ := accountService.FindByID(oldAccountID)
	newAccount, _ := accountService.FindByID(newAccountID)
...
func TestOnTransactionAccountRemoved(t *testing.T) {
	...
	toAccount, _ := accountService.FindByID(toAccountID)
	fromAccount, _ := accountService.FindByID(fromAccountID)
